...
#           self.db[input[1]] = input[2]
    ...
    def handle(self):
        ...
        self.db_init()
        self.data = self.request[0].strip()#self.request.recv(1024).strip()
        ...
        socket.sendto(sent_back_db_value, self.client_address)
...
if __name__ == "__main__":
    ...
    logging.basicConfig(filename='server_udp.log', level=logging.INFO)
